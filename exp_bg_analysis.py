...
def prior_transform_cos1(P):
    return np.array([d(cos1.x[0])*P[0]+b(cos1.x[0]) , d(cos1.x[1])*P[1]+b(cos1.x[1]) , 
                     d(cos1.x[2])*P[2]+b(cos1.x[2]) , 
                     d(cos1.x[3])*P[3]+b(cos1.x[3]) , d(cos1.x[4])*P[4]+b(cos1.x[4]) ,
                     d(cos1.x[5])*P[5]+b(cos1.x[5]) ] )

def prior_transform_cos2(P):
    return np.array([d(cos2.x[0])*P[0]+b(cos2.x[0]) , d(cos2.x[1])*P[1]+b(cos2.x[1]) , 
                     d(cos2.x[2])*P[2]+b(cos2.x[2]) , 
                     d(cos2.x[3])*P[3]+b(cos2.x[3]) , d(cos2.x[4])*P[4]+b(cos2.x[4]) ,
                     d(cos2.x[5])*P[5]+b(cos2.x[5]) ] )    
...
print("\n1-6keV")
frequentist(cos1.x, bg1.x, data1)
AIC(cos1.x, bg1.x, data1)
